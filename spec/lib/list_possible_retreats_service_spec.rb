...
RSpec.describe ListPossibleRetreatsService, type: :service do
  describe '#call' do
    context "after Diagram 8:" do
      ...
      let(:ordermenu) { ListPossibleRetreatsService.call(turn: @turn, power: @power_g, unit: @unit_g_bur, standoff: @standoff) }

      example "bur の陸軍はその場での解隊を選択できる" do
        expect(ordermenu.any?{|o| o.disband?}).to be true
      end

      example "bur の陸軍は 5 つの地域に撤退できる" do
        expect(ordermenu.select{|o| o.retreat?}.size).to eq 5
      end
    ...
    context "Diagram 12:" do
      ...
      let(:ordermenu) { ListPossibleRetreatsService.call(turn: @turn, power: @power_g, unit: @dislodged_unit, standoff: @standoff) }
      ...
      example "mun の陸軍は 3 つの地域に撤退できる" do
        expect(ordermenu.select{|o| o.retreat?}.size).to eq 3
      end
    ...
    context "Diagram 13:" do
      ...
      let(:ordermenu) { ListPossibleRetreatsService.call(turn: @turn, power: @power_t, unit: @dislodged_unit, standoff: @standoff) }
      ...
      example "bul の陸軍は 2 つの地域に撤退できる" do
        expect(ordermenu.select{|o| o.retreat?}.size).to eq 2
      end
    ...
    context "Diagram 14:" do
      ...
      example "bul の陸軍は 1 つの地域に撤退できる" do
        expect(ordermenu.select{|o| o.retreat?}.size).to eq 1
      end
    ...
    context "Diagram 16:" do
      ...
      let(:ordermenu) { ListPossibleRetreatsService.call(turn: @turn, power: @power_r, unit: @dislodged_unit, standoff: @standoff) }
      ...
      example "war の陸軍は 4 つの地域に撤退できる" do
        expect(ordermenu.select{|o| o.retreat?}.size).to eq 4
      end
    ...
    context "Diagram 21:" do
      ...
      let(:ordermenu) { ListPossibleRetreatsService.call(turn: @turn, power: @power_f, unit: @dislodged_unit, standoff: @standoff) }
    ...
    context "Diagram 29:" do
      ...
      let(:ordermenu) { ListPossibleRetreatsService.call(turn: @turn, power: @power_e, unit: @dislodged_unit, standoff: @standoff) }
    ...
    context "Diagram 32:" do
      ...
      let(:ordermenu) { ListPossibleRetreatsService.call(turn: @turn, power: @power_i, unit: @dislodged_unit, standoff: @standoff) }
      ...
      example "nap の海軍は撤退できる地域がない" do
        expect(ordermenu.select{|o| o.retreat?}.size).to eq 0
      end
