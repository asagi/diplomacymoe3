        ...
        context '処理フェイズが日付を跨がない場合' do
          ...
          example '開幕から春外交フェイズへ' do
            ...
            travel_to(time) do
              ...
              expect(
                @table.next_period(next_phase: Const.phases.spr_1st)
          ...
          example '春外交フェイズから春撤退フェイズへ' do
            ...
            travel_to(time) do
              ...
              expect(
                @table.next_period(next_phase: Const.phases.spr_2nd)
          ...
          example '春撤退フェイズから秋外交フェイズへ：早回し' do
            ...
            travel_to(time) do
              ...
              @table.last_nego_period = Time.zone.parse('2019-05-05 20:00')
              expect(
                @table.next_period(next_phase: Const.phases.fal_1st)
          ...
          example '秋外交フェイズから秋撤退フェイズへ' do
            ...
            travel_to(time) do
              ...
              expect(
                @table.next_period(next_phase: Const.phases.fal_2nd)
          ...
          example '秋撤退フェイズから秋調整フェイズへ：早回し' do
            ...
            travel_to(time) do
              ...
              @table.last_nego_period = Time.zone.parse('2019-05-06 20:00')
              expect(
                @table.next_period(next_phase: Const.phases.fal_3rd)
